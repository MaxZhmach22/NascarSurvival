...
Shader "OCTAVIAN/SliderRampSpecularRimTriPlanar"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom vertex:vert exclude_path:deferred exclude_path:prepass vertex:vert
		#pragma target 3.0
